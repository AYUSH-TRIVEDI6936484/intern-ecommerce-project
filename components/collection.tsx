...
const badgeClasses =
  'absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white dark:bg-zinc-800 var(--o-text-black) w-[150px] h-[41.6px] rounded-md shadow-lg text-center flex items-center justify-center font-semibold text-[14px]';
    ...
    <div className="bg-[var(--o-july-background)] pt-5 pb-18 max-w-[1200px] 2xl:max-w-[1440px] mx-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-bold var(--o-text-black)">
            Shop by Categories
          </h2>
        </div>
