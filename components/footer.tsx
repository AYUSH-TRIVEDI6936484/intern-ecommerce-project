...
const Footer = () => {
  return (
    <footer className="bg-[var(--text-black)] text-[var(--o-white)] py-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-4" style={{ width: '100%', maxWidth: '1200px', height: 'auto' }}>
        <div className="p-[15px]">
          ...
          <p className="mt-4 text-sm">
            E.{' '}
            <a href="mailto:hello@uxper.co" className="underline">hello@uxper.co</a>
            <br />
            T. (00) 342 489 33
          </p>
        </div>
