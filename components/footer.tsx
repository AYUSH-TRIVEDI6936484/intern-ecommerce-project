...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-10">
      <div className="container gap-0 mx-[129px] grid grid-cols-1 md:grid-cols-5" style={{ width: '1200px', height: '221px'}}>
        <div className='p-[15px]'>
          <h3 className="font-semibold text-xl mb-4">About Shop</h3>
          <p className="text-sm">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. <a href="#" className="underline">Read More</a>
          </p>
          <p className="mt-4 text-sm">
            E. <a href="mailto:hello@uxper.co" className="underline">hello@uxper.co</a><br />
            T. (00) 342 489 33
          </p>
        </div>
        <div className='p-[15px]'>
        ...
        <div className='p-[15px]'>
          ...
          <ul className="text-sm space-y-2">
            ...
            <li><a href="#" className="hover:underline">Return My Order</a></li>
        ...
        <div className='p-[15px]'>
          ...
          <ul className="text-sm space-y-2">
            <li><a href="#" className="hover:underline">Duties & Taxes</a></li>
