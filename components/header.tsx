...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 left-0 w-full flex justify-center items-center z-50 transition-all duration-300 h-[74px] bg-[var(--o-july-background)]">
      <nav className="max-w-[1200px] 2xl:max-w-[1440px] w-full flex justify-between items-center px-4 md:px-0">
        <div className="flex items-center w-[50%] md:w-[20%] justify-start md:justify-center">
          <Image
            src="https://july.uxper.co/fashion01/wp-content/uploads/sites/2/2022/04/logo-july-dark-1-20220704-030304.svg"
            alt="logo"
            width={150}
            height={300}
        ...
        <div className="hidden md:flex items-center space-x-6 justify-center w-full md:w-[60%]">
        ...
        <div className="hidden md:flex items-center justify-end space-x-4 cursor-pointer w-[50%] md:w-[20%]">
          <svg
            width="28"
            height="28"
            viewBox="0 0 28 28"
        ...
        <div className="md:hidden flex items-center justify-end w-[50%]">
          <button
